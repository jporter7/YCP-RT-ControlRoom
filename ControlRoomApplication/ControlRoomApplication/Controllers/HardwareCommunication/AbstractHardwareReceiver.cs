...
{
    public abstract class AbstractHardwareReceiver
    {
        ...
        public AbstractHardwareReceiver(IPAddress ip_address, int port)
        {
            try
            {
        ...
        public AbstractHardwareReceiver(string ip, int port) : this(IPAddress.Parse(ip), port) { }
